    ...
    return (
      <div className="music-station">
          <div className="music-station-links">
            <h2 style={{"textDecoration": "underline"}}>MusicStation</h2>
            ...
            <p><strong>Front-End:</strong> React, Redux</p>
            <p><strong>Back-End:</strong> Rails API, ActiveStorage and Postgres database</p>
          </div>
